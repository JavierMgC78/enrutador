<section class="hero-section">
    <div class="container hero-content">
        ...
        <form action="" method="POST" style="max-width: 400px; margin: 0 auto; background: rgba(255,255,255,0.05); padding: 40px; border-radius: 20px; backdrop-filter: blur(10px); box-shadow: var(--shadow-soft); border: 1px solid rgba(212,175,55,0.2);">
